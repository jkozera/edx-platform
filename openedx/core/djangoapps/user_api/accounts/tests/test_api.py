...
class TestAccountApi(UserSettingsEventTestMixin, TestCase):
    ...
    def test_get_username_provided(self):
        ...
        account_settings = get_account_settings(self.default_request, username=self.user.username)[0]
        self.assertEqual(self.user.username, account_settings["username"])

        account_settings = get_account_settings(self.default_request, username=self.different_user.username)[0]
